...
<head>
    ...
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="57x57" href="{{ asset('assets') }}/images/brand/icon.webp" />
    <link rel="apple-touch-icon" sizes="60x60" href="{{ asset('assets') }}/images/brand/icon.webp" />
    <link rel="apple-touch-icon" sizes="72x72" href="{{ asset('assets') }}/images/brand/icon.webp" />
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('assets') }}/images/brand/icon.webp" />
    <link rel="apple-touch-icon" sizes="114x114" href="{{ asset('assets') }}/images/brand/icon.webp" />
    <link rel="apple-touch-icon" sizes="120x120" href="{{ asset('assets') }}/images/brand/icon.webp" />
    <link rel="apple-touch-icon" sizes="144x144" href="{{ asset('assets') }}/images/brand/icon.webp" />
    <link rel="apple-touch-icon" sizes="152x152" href="{{ asset('assets') }}/images/brand/icon.webp" />
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('assets') }}/images/brand/icon.webp" />
    <link rel="icon" type="image/png" sizes="192x192" href="{{ asset('assets') }}/images/brand/icon.webp" />
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('assets') }}/images/brand/icon.webp" />
    <link rel="icon" type="image/png" sizes="96x96" href="{{ asset('assets') }}/images/brand/icon.webp" />
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('assets') }}/images/brand/icon.webp" />
    <link rel="shortcut icon" href="{{ asset('assets') }}/images/brand/icon.webp" />
    <link rel="apple-touch-icon" href="{{ asset('assets') }}/images/brand/icon.webp">
    <!-- Favicon -->
    ...
    <link rel="stylesheet" href="https://cdn.salla.network/fonts/apple.css?v=2.0.3" />
...
<body class="transition-all duration-500 bg-zinc-50 dark:bg-zinc-900" x-data="{ url: JSON.parse(localStorage.getItem('url')) }"  x-init="$watch('url', (val) => localStorage.setItem('url', val))">
                ...
                <div class="space-y-3">
                    <div class="flex flex-col items-center justify-center h-screen animate__animated animate__fadeIn">
                        <div class="animate__animated animate__pulse animate__infinite animate__slower">
                            <x-logo class="h-[124px] w-auto" preload />                            
                        </div>
                    </div>
                </div>
            </div>
