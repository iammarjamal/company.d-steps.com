    ...
    <div class="w-full pt-4 px-6 mt-1 border-t border-zinc-900/5 dark:border-zinc-50/5">
        <div x-data="{ selectedTab: 'create' }" class="w-full">
            ...
            <div class="px-2 py-4 text-slate-700 dark:text-slate-300">
                <div x-show="selectedTab === 'create'" id="create" role="tabpanel" aria-label="create">  <div><livewire:pages.users.pages.notifications.pages.create/></div> </div>
                <div x-show="selectedTab === 'sent'" id="sent" role="tabpanel" aria-label="sent"> <div><livewire:pages.users.pages.notifications.pages.sent/></div> </div>
                <div x-show="selectedTab === 'inbox'" id="inbox" role="tabpanel" aria-label="inbox"> <div><livewire:pages.users.pages.notifications.pages.inbox/></div> </div>
            </div>
        </div>
