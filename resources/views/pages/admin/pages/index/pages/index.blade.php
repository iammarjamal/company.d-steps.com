                ...
                <x-camelui::card class="p-6" rounded="2xl">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-medium text-gray-900 dark:text-white">{{$totalHRUsers}}</p>
                        </div>
...
{{--            <div class="p-1 sm:w-full md:w-full lg:w-1/2 xl:w-1/2">--}}
{{--                <x-camelui::card class="p-6" rounded="2xl">--}}
{{--                    <div class="flex items-center justify-center my-64">--}}
