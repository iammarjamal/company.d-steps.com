<a>
    ...
    @else
        <img class="w-auto h-12 max-w-full sm:h-10 dark:hidden" src="{{route('home.index')}}/assets/images/brand/logo.png" alt="logo-dark" />
        <img class="hidden w-auto h-12 max-w-full sm:h-10 dark:block" src="{{route('home.index')}}/assets/images/brand/logo.png" alt="logo-light" />
    @endif
</a>
